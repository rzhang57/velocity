...
export default function VideoEditor() {
  ...
  }, [videoPath, cameraVideoPath, recordingSession, cameraHiddenRegions, wallpaper, zoomRegions, trimRegions, shadowIntensity, showBlur, motionBlurEnabled, cursorTrailEnabled, customCursorSize, customCursorTelemetry, borderRadius, padding, cropRegion, annotationRegions, isPlaying, mp4FrameRate, mp4Resolution, exportDirectory]);
      ...
      >
        <div className="flex items-center gap-2" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
          ...
          <button
            ...
            style={{ position: 'absolute', right: '12px', top: '50%', transform: 'translateY(-50%)' } as React.CSSProperties}
            className="h-7 px-3 rounded-md border border-red-300/20 bg-red-500/70 text-xs text-[#c8f4df] hover:bg-red-700/20 disabled:opacity-50 disabled:cursor-not-allowed transition-colors mr-2"
          >
            New Recording
          </button>
        </div>
